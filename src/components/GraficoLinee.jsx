...
export default function GraficoLinee(props){
    ...
    return (
      ...
      <Col>
         ...
         <Card.Title className="titleStat">Statistiche Esercizi {item.id}</Card.Title>
          ...
          <Line  data={{
             labels: [0, "RISPOSTE TOTALI: " + ' ' + (item.nRisposteEsatte+item.nRisposteSbagliate ||item.nRisposteEsatte || item.nRisposteSbagliate || 0),],
             datasets: [
               {
                label: "RISPOSTE CORRETTE: " + ' ' + (item.nRisposteEsatte || 0),
                data: [0,item.nRisposteEsatte || 0],
                backgroundColor:  "#26d626",
                borderColor:  "#26d626",
              },
              {
                label:"RISPOSTE ERRATE: "+ ' ' + (item.nRisposteSbagliate || 0),
                data: [0,item.nRisposteSbagliate || 0],
