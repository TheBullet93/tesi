...
const AssegnaDomandeEsFisico = (props) =>{
  ...
  const aggiungi = () => {
    setCount(count + 1);
    const postListRef = ref(db,`/terapisti/${props.idTerapista}/pazienti/${props.idPaziente}/trattamenti/fisici/${props.index}/domande/${count}`);
...
export default AssegnaDomandeEsFisico;